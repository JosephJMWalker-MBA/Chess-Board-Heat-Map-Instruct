...
### Blocker Dependency Order
 ...
 4. SOURCE_ONLY_FEASIBILITY_COVERAGE_ACQUISITION (measures CP eligibility, pair counts after root/instrument are frozen. May not inspect held-out target labels)
